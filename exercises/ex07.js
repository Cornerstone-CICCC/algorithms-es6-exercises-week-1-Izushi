...
const academicBackground = "a Master's degree";
let averageSalary;
...
console.log(`In 2015, a person with ${academicBackground} earned an average of $${averageSalary.toLocaleString("en-US")}/year.`)